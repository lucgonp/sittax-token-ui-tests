...
declare namespace Cypress {
  interface Chainable {
    ...
    /**
     * Navega até a página de Atualizações (Utilitários → Atualizações) via navbar.
     */
    navegarParaAtualizacoes(): Chainable<void>;

    /**
     * Navega até a página de Logs (Utilitários → Logs) via navbar.
     */
